...
class FoodOrdersApp:
    ...
    def add_meals_to_menu(self, *meals):
        for meal in meals:
            if type(meal).__name__ in self.VALID_MEALS:
    ...
    def finish_order(self, client_phone_number: str):
        ...
        client.bill = 0
        self.receive_id += 1
        return f"Receipt #{self.receive_id} with total amount of {bills:.2f} was successfully paid for {client_phone_number}."
