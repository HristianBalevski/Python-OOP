...
Класовете не трябва да бъдат принуждавани да зависят от методи, които не използват. В Python, въпреки че нямаме официални интерфейси, можем да използваме **миксинообразни класове**, за да разделим различни поведения.
